  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute top-1/3 left-1/2 -translate-x-1/2 w-150 h-150 rounded-full blur-3xl opacity-20 ${
        ...
        <div className="relative bg-card/95 backdrop-blur-xl border border-border rounded-3xl p-8 space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-muted/50 border border-border space-y-3">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-medium text-foreground truncate max-w-45">{email}</span>
            </div>
            <div className="flex items-center justify-between text-sm">
