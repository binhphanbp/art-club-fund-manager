        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Chúng mình nhận thấy bạn chưa nộp quỹ cho <strong>Tuần {currentWeek}</strong> của năm nay.
            </Text>
            ...
            <Section style={ctaSection}>
              <Link href="https://artclub.example.com/dashboard" style={ctaButton}>
                Nộp Quỹ Ngay 💰
              </Link>
            </Section>
            ...
            <Section style={bankInfo}>
              ...
              <Text style={bankInfoItem}>
                <strong>Nội dung:</strong> CLB NT - {memberName} - Tuan {currentWeek}
              </Text>
            </Section>
