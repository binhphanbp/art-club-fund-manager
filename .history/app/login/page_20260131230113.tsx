        ...
        <div className="relative bg-card/90 backdrop-blur-xl border border-border rounded-3xl p-8 sm:p-10">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Đăng nhập để quản lý quỹ CLB Nghệ Thuật
            </p>
          </motion.div>
          ...
          >
            <Button
              ...
              disabled={isLoading}
              className="w-full h-14 bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 rounded-xl font-medium text-base shadow-sm transition-all duration-200 hover:shadow-md"
            >
              {isLoading ? (
          ...
          >
            <p className="text-xs text-center text-purple-300">
              💡 Thành viên mới sẽ được cấp quyền <strong>MEMBER</strong>. Liên hệ Admin để nâng cấp quyền.
            </p>
          </motion.div>
        </div>
      </motion.div>
