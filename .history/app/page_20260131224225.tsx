                  ...
                  >
                    ...
                    <div className={`relative bg-card/80 backdrop-blur-sm border rounded-2xl p-6 transition-all duration-300 ${
                      ...
                      <div className="flex flex-col items-center mt-4">
                        ...
                        <p className="text-muted-foreground text-sm mb-3">{leader.role}</p>
                        ...
                        <AnimatePresence>
                          {activeLeader === index && (
                            <motion.p
                              ...
                              className="text-muted-foreground text-sm italic text-center border-t border-border pt-3 mt-2"
                            >
                              "{leader.quote}"
                            </motion.p>
                          )}
