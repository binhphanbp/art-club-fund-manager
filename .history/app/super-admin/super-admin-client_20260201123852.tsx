...
export default function SuperAdminClient({
  ...
  const [deletingMember, setDeletingMember] = useState<UserWithCount | null>(
    null,
  );
  ...
  const [settingsForm, setSettingsForm] = useState({
    weeklyFundAmount: settings?.weeklyFundAmount || 20000,
  ...
  const handleDepartmentChange = async (
    ...
    try {
      ...
      if (result.success) {
        ...
        setMembers((prev) =>
          prev.map((m) =>
            m.id === userId ? { ...m, department: newDepartment } : m,
          ),
        );
      } else {
        toast.error(result.error);
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-card border border-border">
            ...
            <p className="text-2xl font-bold text-foreground">
              {(settings?.weeklyFundAmount || 20000).toLocaleString()}đ
            </p>
          </div>
          <div className="p-4 rounded-xl bg-card border border-border">
            <div className="flex items-center gap-2 mb-1">
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-center">
                    ...
                    <div className="sm:col-span-4 flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-full bg-linear-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold`}
                      >
                    ...
                    <div className="sm:col-span-2">
                      <div className="relative">
                        ...
                        >
                          {(Object.keys(departmentConfig) as Department[]).map(
                            (dept) => (
          ...
          <div className="px-4 pb-4 space-y-4 overflow-y-auto">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setSettingsForm({ ...settingsForm, clubName: e.target.value })
                }
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettingsForm({
                      ...settingsForm,
                      weeklyFundAmount: Number(e.target.value),
                    })
                  }
            ...
            {deletingMember && (
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/30">
                <p className="text-foreground">
                  ...
                  <strong>{deletingMember.fullName}</strong>?
                </p>
                <p className="text-sm text-muted-foreground mt-2">
                  Tất cả {deletingMember._count.contributions} đóng góp của
                  thành viên này cũng sẽ bị xóa.
                </p>
              </div>
            )}
          </div>
