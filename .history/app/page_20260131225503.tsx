        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 relative pt-20 sm:pt-16 pb-8">
          ...
          >
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-purple-300">Where Art Meets Passion</span>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                  ...
                  <div className="relative bg-card/80 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 overflow-hidden h-full">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="text-2xl font-bold text-foreground mb-2">{exec.name}</h3>
                      <p className={`text-transparent bg-linear-to-r ${exec.gradient} bg-clip-text font-semibold text-lg mb-2`}>
                        {exec.role}
                      </p>
                      <p className="text-muted-foreground text-sm">{exec.description}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-purple-500/10 border border-purple-500/20 mb-4 sm:mb-6">
                ...
                <span className="text-xs sm:text-sm text-purple-300">Team Leaders</span>
              </div>
              ...
              <div className="flex md:grid md:grid-cols-3 gap-4 sm:gap-6 overflow-x-auto pb-4 md:pb-0 snap-x snap-mandatory scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0">
                {teamLeaders.map((leader, index) => (
                  ...
                  >
                    ...
                    <div className={`relative bg-card/80 backdrop-blur-sm border rounded-2xl p-5 sm:p-6 transition-all duration-300 h-full ${
                      activeLeader === index 
                        ? 'border-white/30 bg-card' 
                        : 'border-border hover:border-white/20'
                    }`}>
                      {/* Team badge */}
                      <div className={`absolute -top-3 left-1/2 -translate-x-1/2 px-3 sm:px-4 py-1 rounded-full bg-linear-to-r ${leader.gradient} text-white text-[10px] sm:text-xs font-bold shadow-lg`}>
                        {leader.team}
                      </div>

                      {/* Icon & Avatar */}
                      <div className="flex flex-col items-center mt-3 sm:mt-4">
                        <div className={`w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-linear-to-br ${leader.gradient} flex items-center justify-center mb-3 sm:mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                          <leader.icon className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                        </div>
                        
                        <h4 className="text-lg sm:text-xl font-bold text-foreground mb-1">{leader.name}</h4>
                        <p className="text-muted-foreground text-xs sm:text-sm mb-2 sm:mb-3">{leader.role}</p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-xl text-foreground">Art Club Fund Manager</span>
              </div>
