      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {/* Role Badge */}
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r ${roleColors[user.role]} text-white text-sm font-semibold shadow-lg`}>
        ...
        >
          ...
          <div className="relative group">
            <div className={`absolute inset-0 bg-linear-to-br ${departmentColors[user.department]} opacity-20 rounded-2xl blur-xl group-hover:opacity-30 transition-opacity`} />
            <div className="relative bg-card border border-border rounded-2xl p-6">
              <div className={`w-12 h-12 rounded-xl bg-linear-to-br ${departmentColors[user.department]} flex items-center justify-center mb-4`}>
                <DeptIcon className="w-6 h-6 text-white" />
              </div>
              <p className="text-muted-foreground text-sm mb-1">Ban</p>
              <p className="text-xl font-bold text-foreground">{departmentNames[user.department]}</p>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card border border-border rounded-2xl p-6">
              ...
              <p className="text-muted-foreground text-sm mb-1">Tổng đóng góp</p>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card border border-border rounded-2xl p-6">
              ...
              <p className="text-xl font-bold text-foreground">{pendingContributions}</p>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card border border-border rounded-2xl p-6">
              ...
              <p className="text-xl font-bold text-foreground">{approvedContributions}</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-muted-foreground text-sm mb-1">Ngày tham gia</p>
          ...
          {user.contributions.length === 0 ? (
            ...
            <div className="space-y-4">
              {user.contributions.map((contribution) => (
                ...
                >
                  <div>
                    <p className="font-medium text-foreground">{contribution.week}</p>
        ...
        {(user.role === "ADMIN" || user.role === "SUPER_ADMIN") && (
          ...
          >
            ...
            <p className="text-muted-foreground mb-4">
              Bạn có quyền {user.role === "SUPER_ADMIN" ? "Super Admin" : "Admin"}. Truy cập trang quản trị để quản lý thành viên và đóng góp.
            </p>
            <Link href="/admin">
