    ...
    <div className="min-h-screen bg-[#070709] relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute -bottom-60 -left-40 w-175 h-175 rounded-full"
      ...
      <div className="relative z-10 container mx-auto max-w-2xl px-4 py-8 space-y-6">
        ...
        >
          ...
          <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-white/4 backdrop-blur-2xl p-6">
            {/* Inner top shimmer */}
        ...
        >
          ...
          <div className="relative rounded-3xl border border-white/10 bg-white/4 backdrop-blur-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="h-11 px-4 rounded-xl bg-white/3 border border-white/10 flex items-center gap-2 cursor-not-allowed">
